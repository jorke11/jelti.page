...
trait Invoice {
    ...
    function formatDetail($id) {
        $detail = DB::table("departures_detail")->
                        select("departures_detail.id", "departures_detail.status_id", "departures_detail.product_id", DB::raw("coalesce(departures_detail.description,'') as comment"), "departures_detail.real_quantity", "departures_detail.quantity", "departures_detail.value", DB::raw("vproducts.reference ||' - ' ||vproducts.title || ' - ' || stakeholder.business  as product"), "departures_detail.description", "parameters.description as status", "stakeholder.business as stakeholder", "vproducts.bar_code", "vproducts.units_sf", "departures_detail.tax", "vproducts.thumbnail")
